...
// Função para selecionar 2 personagens aleatórios
...
async function playRaceEngine(character1, character2) {
  for (let round = 1; round <= 5; round++) {
    ...
    if (block === "CONFRONTO") {
      ...
      // Bug corrigido: vencedor ganha ponto E perdedor perde ponto
      if (powerResult1 > powerResult2) {
        console.log(
          `${character1.NOME} venceu o confronto! ${character1.NOME} ganhou 1 ponto e ${character2.NOME} perdeu 1 ponto 🥊`
        );
        character1.PONTOS++;
        ...
        console.log(
          `${character2.NOME} venceu o confronto! ${character2.NOME} ganhou 1 ponto e ${character1.NOME} perdeu 1 ponto 🥊`
        );
        character2.PONTOS++;
